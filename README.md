...
> 技能面：`Tools/skills/`（P-2026-09-26-01 集团技能动员令·司内现状=零在册技能；会话内置 codely-guide/skill-creator/tuanjie-cli 即用；三问筛过线建队候选=city-sandbox 布设沙盒门族/bake-pipeline GDI+ 自焙管线——建队切片随 TECH §九 技能令行分轮领·登记行随建随接）。
