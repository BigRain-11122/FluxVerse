...
| ID | 任务 | 指针/判据 | 状态 |
|---|---|---|---|
| T-FV-002 | 00:10 美术整改令分轮施工：①核心 tile 集/上海天际线轮廓强化（禁蓝方块平铺）②水面 L0 显著度 ③黄昏黄金档验证 ④名牌迁 UI 壳层 ⑤与 art-target-dusk 并排对比图过 §五 6 条验收 | orders.md 09-26 00:10 行；TECH §九 r175 行（S2 地标自焙已收口·下一领=S3 布设沙盒轮：换装 manifest+冠锚 tip 区+招牌/檐位/bloom/倒影源四联动重推导）；判据=新截图肉眼接近目标图气质；品字 F-03/门债 F-10/hue-shift F-17 三呈报件随整改批再呈（D-20260926-05⑧） | open |
