...
| ID | 任务 | 指针/判据 | 状态 |
|---|---|---|---|
| T-FV-001 | 00:10 美术整改令施工序勘定轮：art-style-spec §五像素技法 6 条判据对表+现城 tile/资产 vs art-target-dusk 差距测绘+④名牌迁 UI 壳层方案+塔形冲突（花苞 vs v2.0 楔形）呈报定谳 | orders.md 09-26 00:10 行；TECH §九 r173 行①；r139 勘定范式 | open |
| T-FV-002 | 00:10 美术整改令分轮施工：①核心 tile 集/上海天际线轮廓强化（禁蓝方块平铺）②水面 L0 显著度 ③黄昏黄金档验证 ④名牌迁 UI 壳层 ⑤与 art-target-dusk 并排对比图过 §五 6 条验收 | orders.md 09-26 00:10 行；判据=新截图肉眼接近目标图气质；品字 F-03/门债 F-10/hue-shift F-17 三呈报件随整改批再呈（D-20260926-05⑧） | open |
