...
| ID | 任务 | 指针/判据 | 状态 |
|---|---|---|---|
| T-FV-131 | P-2026-09-26-04 城市承载基建块面调研件（六必答·R-20260926-city-block-<域>.md ≤300 行·plot 落位建议）+P-2026-09-26-18 调研部建制回执（复用件声明+席位台账+节律+统计面板落位·X068 零新建） | 源=evolution-ledger L119/L184+U231/U247 令文+F-20260926-23 认领回执；**回执窗 ≤09-28 12:00**；判据=六必答全答+P-65 三件套挂承接+≤300 行 | open |
| T-FV-132 | P-2026-09-26-05 时间层令本仓切片：通电批语义勘定（「停摆」观察源 vs 异机可见性）+world-state 四字段（city_phase/weather/season/load_tide 按正典 §二/§四 枚举照抄）+城市卡机读派生数据面（U155⑤）+四季色板 GATED 面勘定 | 源=evolution-ledger L120+《硅基城市时间与节律正典.md》GLOBAL+F-20260926-24 认领回执；**窗 ≤09-29**；已交付面注记=雨涟漪/湿反光/色轮/窗灯现役（验收=真互动三证复扫） | open |
